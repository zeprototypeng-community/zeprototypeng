...
import { Permission } from 'src/app/application/models/permission';
...
export class PermissionComponent implements OnInit {
  ...
  url = apiRoutes.permissions;
  singleData: Permission;
  data: PaginateResponse = new PaginateResponse(new Permission);
  ...
  async buildForm() {
    this.form = await this.formService.getForm(formIds.permissionFormId);
  ...
  onDeleteAttempt(id: number) {
    if (!this.singleData) {
      this.singleData = new Permission();
    }
